...
public abstract class AbstractDSRomHandler extends AbstractRomHandler {
    ...
    protected int readWord(byte[] data, int offset) {
        //System.out.println("data[offset]:"+data[offset]+"|"+Integer.toHexString(data[offset]));
       // System.out.println("data[offset+1]:"+data[offset+1]+"|"+Integer.toHexString(data[offset+1]));
